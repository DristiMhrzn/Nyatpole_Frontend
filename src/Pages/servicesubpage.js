    ...
    <div className="service-page">
      ...
      <section ref={stemRef} className="service-section">
        ...
        <div className="service-content">
          ...
          <p>
            Our STEM Education Programs are designed to build a strong academic
            and practical foundation in Science, Technology, Engineering, and
            Mathematics. We focus on experiential learning rather than rote
            memorization.
          </p>
          <p>
            Students actively participate in experiments, mini-projects, and
            interactive activities that enhance analytical thinking, creativity,
            and innovation.
          </p>
          {renderHighlights([
